...
const cars_url = {
  ...
  CHECK_CAR_VCID:
    "/ccyChekuangdashi/ccyChekuangdashi/app/carOwner/checkReport/VcId/byReceptionId/", //get VcId
  CHECK_CAR_TEST_URL:
    "/ccyChekuangdashi/ccyChekuangdashi/app/carOwner/checkReport/AllReportInfo/ForShare/byReceptionId/", //车辆检测列表接口
  CHECK_CAR_DETAIL:
    "/ccyChekuangdashi/ccyChekuangdashi/app/carOwner/checkReport/OneVc/byVcId/", //get 车辆检测详情详情页
  GET_CAR_REMAINS:
...
const receive_url = {
  ...
  RECIVERCAR_UPLOADER_VEDIO: "/uploadFile/upload/video", //上视频
...
const report_home_url = {
  ...
  GET_REPORT_NEW_HOME:
    "/ccyChekuangdashi/ccyChekuangdashi/app/categores/v2/checkInit/byReceptionId/", //录入报告首页数据接口
...
const opportunity_url = {
  ...
  GET_OPPORTUNITY_DATA:
    "/ccyChekuangdashi/ccyChekuangdashi/app/vc/getMaintenanceRecord/byCarId/"
};
//确认施工
const construction_url = {
  GET_CONSTRUCTION_LIST_URL:
    "/ccyChekuangdashi/ccyChekuangdashi/app/work/allItems/byChecksId/", //确认施工所有检测项目
  ...
  GET_SHARE_REPORT_URL:
    "/ccyChekuangdashi/ccyChekuangdashi/app/vc/share/callback/" //分享报告成功回调请求
};
...
const support_url = {
  ...
  GET_SHARE_BOOKLET_URL:
    "/ccyChekuangdashi/ccyChekuangdashi/app/reception/share/callback/" //分享保养手册成功回调请求
};
//报告分享
...
const accessories_url = {
  GET_ACCESSORIES_URL:
    "/ccyChekuangdashi/ccyChekuangdashi/app/part/part/getPartPrice/",
  SEARCH_ACCESSORIES_URL:
    "/ccyChekuangdashi/ccyChekuangdashi/app/part/part/getPartPrice/",
  GET_ACCESSORIES_TYPES_URL:
    "/ccyChekuangdashi/ccyChekuangdashi/app/part/part/getCategoryByCar/",
  GET_ACCESSORIES_TYPES_BY_TYPE_URL:
    "/ccyChekuangdashi/ccyChekuangdashi/app/part/part/getPartPicPart/"
};

//遗留问题
const historyQuestion_url = {
  SUBMIT_HISTORY_QUESTION:
    "/ccyChekuangdashi/ccyChekuangdashi/app/vc/setOtherStoreRepair/car/", //提交遗留问题为他店修复
  QUERY_HISTORY_QUESTION:
    "/ccyChekuangdashi/ccyChekuangdashi/app/reception/car/hisPartList/", //查询遗留问题
  QUERY_HISTORY_QUESTION_EXPAND:
    "/ccyChekuangdashi/ccyChekuangdashi/app/part/getHisPartInfo/byPartCheckResultId/" //查询遗留问题
};
/**
 * 报价单
 */
const quotation_url = {
  QUERY_CREAT_QUOTATION:
    "/ccyChekuangdashi/ccyChekuangdashi/app/quotation/byReceptionId/",
  ADD_CREAT_QUTATION:
    "/ccyChekuangdashi/ccyChekuangdashi/app/quotationChild/add/",
  EDIT_CREAT_QUTATION:
    "/ccyChekuangdashi/ccyChekuangdashi/app/quotationChild/edit",
  DELETE_CREAT_QUTATION:
    "/ccyChekuangdashi/ccyChekuangdashi/app/quotationChild/byId/",
  SUBMIT_CREAT_QUTATION:
    "/ccyChekuangdashi/ccyChekuangdashi/app/quotation/init",
  SEND_QUOTATION_QUERY:
    "/ccyChekuangdashi/ccyChekuangdashi/app/quotation/byId/",
  SEND_QUOTATION_SELECT:
    "/ccyChekuangdashi/ccyChekuangdashi/app/quotation/sendRP/byId/",
  GET_SHARE_QUOTATION:
    "/ccyChekuangdashi/ccyChekuangdashi/app/vc/sharequotation/callback/" //分享报价单成功回调请求
};
